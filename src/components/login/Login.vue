    ...
    <el-container class="login">
        ...
        <el-main style="padding: 0px">
            <el-row>
                ...
                <el-col :span="24">
                    <div>
                        <div id="form-title">VersionControl</div>
                        <form id="submit-form">
                            <div id="form-content">
                                ...
                                <div id="form-inputs">
                                    <div class="form-input-div">
                                        <i class="iconfont"
                                           style="position: absolute; bottom: 213px; padding-left: 10px">&#xe61c;</i>
                                    ...
                                    <div class="form-input-div">
                                        <i class="iconfont"
                                           style="position: absolute; bottom: 151px; padding-left: 10px">&#xe652;</i>
...
.form-input-div input.has-error {
    border-color: #fc4949;
}
